...
-- Databáza: `dom`
--
CREATE DATABASE IF NOT EXISTS `dom` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dom`;
...
--
CREATE DATABASE IF NOT EXISTS `moja_skupina` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `moja_skupina`;

-- --------------------------------------------------------

--
-- Štruktúra tabuľky pre tabuľku `druha_skupina`
--
-- Error reading structure for table moja_skupina.druha_skupina: #1932 - Table &#039;moja_skupina.druha_skupina&#039; doesn&#039;t exist in engine
-- Error reading data for table moja_skupina.druha_skupina: #1064 - Something is wrong in your syntax blízko &#039;FROM `moja_skupina`.`druha_skupina`&#039; na riadku 1
--
-- Databáza: `phpmyadmin`
--
...
('root', '2026-04-30 09:38:47', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"sk\"}');
